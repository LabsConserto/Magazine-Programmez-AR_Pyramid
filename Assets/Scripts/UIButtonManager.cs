...
///<Disclaimer>
///This script come from Vuforia Resources Samples
                                         ...
                                         IVirtualButtonEventHandler
{
    ...
    void Start()
    {
        ...
        {
            //Adding an event which will be call when the state of the button change
            //Another script is affected by this changement !
    ...
    public void OnButtonPressed(VirtualButtonBehaviour vb)
    {
        ...
        BroadcastMessage("HandleVirtualButtonPressed_"+vb.VirtualButtonName, SendMessageOptions.DontRequireReceiver);

        Debug.Log("Function call is :" + "HandleVirtualButtonPressed_" + vb.VirtualButtonName);
    }
